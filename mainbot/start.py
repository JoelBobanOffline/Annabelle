...
async def start(mainbot, message):
  await message.reply_photo(
    photo = {}
    caption = f"Heya {message.from_user}, I am a powerfull userbot Helper Assistant for [this person](t.me/user?id={MY_ID}). The messages you send here will be forwarded to my master",
